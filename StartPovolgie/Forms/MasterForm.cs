...
namespace StartPovolgie.Forms
{
    public partial class MasterForm : Form
    {
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            var editMasterForm = new AddMasterForm();
            editMasterForm.Closing += addMasterForm_Closing;
            editMasterForm.ShowDialog();
        }

        private void btnDel_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Вы действительно хотите удалить выбранного мастера?", "Удаление", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                {
                    MessageBox.Show("Невозможно удалить выбранного мастера!", "Удаление", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                catch (Exception)
                {
